# Graph Report - hire-flow-next (2026-07-12)

## Corpus Check

- 553 files · ~181,532 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 3106 nodes · 5734 edges · 192 communities (174 shown, 18 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `640e2bb7`
...
Cohesion: 0.24
Nodes (11): buildJobBreakdownSQL(), buildWhereClauses(), defaultDateRange(), getAnalytics(), RawCountRow, RawTrendRow, whereSQL(), FunnelHistorical (+3 more)

### Community 19 - "Community 19"

Cohesion: 0.06
Nodes (42): saveResumeBuilder(), metadata, metadata, AiSuggestionsPanel(), AiSuggestionsPanelProps, priorityColors, scoreColor(), typeLabels (+34 more)
...
Cohesion: 0.13
Nodes (23): ValidationError, DELETE, GET, handleDELETE(), handleGET(), handlePOST(), POST, createNotification() (+15 more)

### Community 23 - "Community 23"

Cohesion: 0.18
Nodes (10): logOutAction(), SocialProvider, { POST, GET }, auth, getSession(), UserStatusResult, ForgotPasswordType, logger (+2 more)
...
Cohesion: 0.17
Nodes (10): Props, metadata, FunnelChart(), filterFromParams(), PerJobAnalyticsPage(), PerJobAnalyticsPageProps, statusBarData(), useJobAnalytics() (+2 more)

### Community 27 - "Community 27"

Cohesion: 0.08
Nodes (20): GET, handleGET(), GET, handleGET(), GET(), Props, AdminUserDetailPage(), adapter (+12 more)
...
Cohesion: 0.09
Nodes (25): ConflictError, ForbiddenError, NotFoundError, UnauthorizedError, ResolvedSession, { DELETE }, { DELETE }, GET (+17 more)
...
Cohesion: 0.08
Nodes (30): metadata, Props, metadata, Props, AdminApplicantDetailRoute(), AdminApplicantDetailPage(), AdminApplicantDetailPageProps, ApplicantActionsSection() (+22 more)

### Community 38 - "Community 38"

Cohesion: 0.18
Nodes (19): BanDialogProps, BulkRejectDialogProps, RevertDialogProps, ConfirmDialogProps, VARIANT_BUTTON, VARIANT_COLORS, VARIANT_ICONS, PdfViewer (+11 more)
...
Cohesion: 0.19
Nodes (11): metadata, CHART_TOOLTIP_STYLE, DistributionBarChart(), DistributionBarChartProps, employmentTypeBarData(), filterFromParams(), jobBreakdownColumns, RecruiterAnalyticsPage() (+3 more)

### Community 43 - "Community 43"

Cohesion: 0.16
Nodes (20): useApplicantsTable(), useApplicants(), useBulkTransitionStatus(), useRevertStatus(), ApplicantListResult, ALLOWED_TRANSITIONS, ApplicationStatusSchema, baseTransitionSchema (+12 more)
...
Cohesion: 0.12
Nodes (22): ApplicantTableToolbar(), ApplicantTableToolbarProps, EMPLOYMENT_TYPE_LABELS, JobTableToolbar(), JobTableToolbarProps, WORK_MODE_LABELS, capitalizeLabel(), formatLabel() (+14 more)
...
Cohesion: 0.16
Nodes (10): metadata, Props, ApplicantTablePagination(), ApplicantTablePaginationProps, ApplicantsTable(), ApplicantsTableProps, ApplicantsTableDialogs(), BulkActionBar() (+2 more)
...
Cohesion: 0.20
Nodes (6): AdminUserProfileView(), AdminUserProfileViewProps, App, useAdminUserApplications(), ShowMoreToggle(), ShowMoreToggleProps

### Community 67 - "Community 67"

Cohesion: 0.15
Nodes (17): ChatHeader(), ChatHeaderProps, ChatMessageList(), MessageItem, Props, SharedThreadView(), ThreadViewConfig, ThreadViewHooks (+9 more)
...
Cohesion: 0.16
Nodes (15): { DELETE }, { GET }, { DELETE }, { GET }, POST(), createMessageIdDeleteHandler(), createThreadListHandler(), MessageIdHandlerOptions (+7 more)
...
Cohesion: 0.08
Nodes (25): 10. `lib/test/schemas/user/profile.schema.test.ts`, 11. `lib/test/schemas/user/resume.schema.test.ts`, 12. `lib/test/schemas/user/resume-ai.schema.test.ts`, 13. `lib/test/schemas/auth/auth.schema.test.ts`, 14. `lib/test/schemas/admin/admin.schema.test.ts`, 15. `lib/test/schemas/notifications/notification.schema.test.ts`, 1. `app/features/recruiter/schema/analytics.schema.ts` — Harden filter params, 2. `app/features/recruiter/schema/job.schema.ts` — Add salary refinement (+17 more)
...
Cohesion: 0.11
Nodes (19): metadata, metadata, AdminTeamList(), InviteAdminForm(), InviteRecruiterForm(), JobTableActionsCell(), JobTableActionsCellProps, JobTableActions (+11 more)
...
Cohesion: 0.27
Nodes (9): listJobs(), listJobs(), buildOffsetMeta(), parseOffsetParams(), AdminJobListResult, AdminJobRow, RecruiterJobDetail, RecruiterJobListResult (+1 more)
...
Cohesion: 0.15
Nodes (11): FormButton(), FormButtonProps, FormInput(), FormInputProps, ResetPasswordForm(), ResetPasswordInput, RegisterInput, SignUpForm() (+3 more)
...
Cohesion: 0.06
Nodes (50): applyAiSuggestions(), ok(), requireRole(), DELETE, handleDELETE(), handlePATCH(), PATCH, GET (+42 more)

### Community 104 - "Community 104"

Cohesion: 0.06
Nodes (41): AdminLayoutClient(), AdminLayout(), Providers(), AccountPopover(), adminLinks, AdminSidebar(), LogoutButton(), MobileNavMenu() (+33 more)

### Community 105 - "Community 105"

Cohesion: 0.10
Nodes (19): Props, AdminRecruiterProfileView(), AdminRecruiterProfileViewProps, CompanyJob, AdminRecruiterDetailPage(), AccountCard(), AccountCardProps, formatDate() (+11 more)
...
Cohesion: 0.11
Nodes (14): handlePOST(), POST, ApiError, TooManyRequestsError, AIProvider, callAI(), PROVIDER_CONFIG, ProviderConfig (+6 more)
...
Cohesion: 0.07
Nodes (33): MessagesPageConfig, MessagesPageLayout(), Props, ThreadListPanel(), Props, ThreadListItem(), ThreadListItemData, AdminMessagesPage() (+25 more)
...
Cohesion: 0.23
Nodes (8): FunnelChartProps, FunnelRow(), FunnelStage, AnalyticsFilterSchema, CHART_COLORS, EMPLOYMENT_TYPE_COLORS, FUNNEL_STAGE_ORDER, WORKMODE_COLORS
...
Cohesion: 0.38
Nodes (8): createRecruiterJobColumns(), EMPLOYMENT_TYPE_LABELS, RecruiterJobsTable(), WORK_MODE_LABELS, useDeleteJob(), useRecruiterJobs(), useToggleJobStatus(), JobListParams
...
Cohesion: 0.16
Nodes (16): disposableSet, emailSchema, ForgotPasswordSchema, PasswordSchema, ResetPasswordSchema, SignInSchema, SignUpSchema, AuthRedirectTargetType (+8 more)
...
Cohesion: 0.15
Nodes (19): ApplicantDetailDialogsProps, ApplicantsTableDialogsProps, ConfirmStatusDialogProps, InterviewFormData, OfferFormData, RejectDialog(), RejectDialogProps, RejectFormData (+11 more)
...
- **1603 isolated node(s):** `$schema`, `plugin`, `snapshot`, `@kilocode/plugin`, `AcceptInviteClientProps` (+1598 more)
...
- **Why does `cn()` connect `Community 65` to `Community 21`, `Community 28`, `Community 29`, `Community 30`, `Community 38`, `Community 167`, `Community 168`, `Community 42`, `Community 171`, `Community 49`, `Community 177`, `Community 51`, `Community 178`, `Community 182`, `Community 55`, `Community 66`, `Community 79`, `Community 80`, `Community 93`, `Community 97`, `Community 104`, `Community 105`, `Community 112`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 103` to `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 27`, `Community 28`, `Community 35`, `Community 37`, `Community 40`, `Community 169`, `Community 54`, `Community 64`, `Community 70`, `Community 82`, `Community 87`, `Community 88`, `Community 95`, `Community 105`, `Community 107`, `Community 111`, `Community 113`, `Community 125`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 38` to `Community 19`, `Community 21`, `Community 28`, `Community 30`, `Community 34`, `Community 37`, `Community 170`, `Community 171`, `Community 172`, `Community 180`, `Community 181`, `Community 55`, `Community 184`, `Community 61`, `Community 65`, `Community 66`, `Community 80`, `Community 82`, `Community 88`, `Community 92`, `Community 97`?**
