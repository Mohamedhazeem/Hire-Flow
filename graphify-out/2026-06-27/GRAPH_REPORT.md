...
## Corpus Check
- 287 files · ~96,105 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1570 nodes · 3188 edges · 109 communities (92 shown, 17 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 45 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26f83871`
...
Cohesion: 0.24
Nodes (14): cn(), Checkbox(), DataTableProps, DialogOverlay(), SelectGroup(), Table(), TableBody(), TableCaption() (+6 more)
...
Cohesion: 0.10
Nodes (30): bulkInviteAdmins(), inviteAdmin(), inviteRecruiter(), loginAction(), registerAction(), requestPasswordResetAction(), resetPasswordAction(), SocialProvider (+22 more)
...
Cohesion: 0.10
Nodes (20): bulkInviteRecruiters(), BulkInviteResult, metadata, InviteRecruiterForm(), Tab, RecruiterTeamList(), InviteListResponse, RecruiterInvite (+12 more)
...
Cohesion: 0.15
Nodes (23): BanDialog(), BanDialogProps, BulkRejectDialogProps, RevertDialogProps, useBanUser(), useUnbanUser(), ConfirmActionButtonProps, ConfirmDialog() (+15 more)
...
Cohesion: 0.09
Nodes (33): ApplicantDetailPageProps, NEXT_ACTIONS, ApplicantsTable(), ApplicantsTableProps, BULK_ACTION_LABELS, BulkActionDef, NEXT_ACTIONS, STATUS_DOT_COLORS (+25 more)
...
Cohesion: 0.18
Nodes (11): metadata, employmentTypeBarData(), filterFromParams(), jobBreakdownColumns, RecruiterAnalyticsPage(), statusBarData(), workModeBarData(), AnalyticsFilterBar() (+3 more)
...
Cohesion: 0.07
Nodes (37): handlePOST(), POST, DELETE, handleDELETE(), DELETE, handleDELETE(), handlePOST(), POST (+29 more)
...
Cohesion: 0.12
Nodes (16): ApplicantDetailPage(), useApplicantDetail(), useTransitionStatusWithRefresh(), ApplicantDetailResponse, getApplicantDetail(), STATUS_LABELS, ApplicationStatusSchema, baseTransitionSchema (+8 more)
...
Cohesion: 0.23
Nodes (11): AdminJobsTable(), JobForm(), RecruiterJobsTable(), useAdminJobs(), useDeleteJob(), useToggleJobStatus(), useCreateJob(), useDeleteJob() (+3 more)
...
Cohesion: 0.22
Nodes (10): metadata, AdminDashboard(), CHART_TOOLTIP_STYLE, WORKMODE_COLORS, useAdminDashboard(), ConfirmActionButton(), Badge(), badgeVariants (+2 more)
...
Cohesion: 0.19
Nodes (7): RecruiterMessagesPage(), ThreadListItem(), ApiEnvelope, ThreadItem, ThreadLastMessage, ThreadUser, useRecruiterThreads()

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (56): requireRole(), ResolvedSession, GET, handleGET(), DELETE, handleDELETE(), handlePATCH(), PATCH (+48 more)

### Community 86 - "Community 86"
Cohesion: 0.16
Nodes (9): AdminMessagesPage(), ThreadListItem(), ThreadItem, ThreadLastMessage, ThreadUser, useAdminThreads(), SearchResult, StartConversationSearch() (+1 more)
...
Cohesion: 0.21
Nodes (8): apiClient(), DEFAULT_QUERY_OPTIONS, defaultQueryFn(), QueryKeyShape, AcceptInviteClient(), metadata, Props, toAbsoluteUrl()
...
Cohesion: 0.21
Nodes (7): AcceptInviteClient(), AcceptInviteClientProps, metadata, Props, AuthLayout(), AuthLayoutProps, authClient

### Community 94 - "Community 94"
Cohesion: 0.20
Nodes (9): recentColumns, RecruiterDashboardProps, StatCard(), StatCardProps, ApplicationStatus, STATUS_MAP, StatusBadge(), StatusBadgeProps (+1 more)
...
Cohesion: 0.09
Nodes (26): AdminJobsTableProps, EMPLOYMENT_TYPE_LABELS, WORK_MODE_LABELS, EMPLOYMENT_TYPE_OPTIONS, JobFormProps, WORK_MODE_OPTIONS, ActionButton(), ActionButtonProps (+18 more)
...
Cohesion: 0.24
Nodes (6): FormButton(), FormButtonProps, ResetPasswordForm(), ResetPasswordInput, metadata, ResetPasswordSchema

### Community 99 - "Community 99"
Cohesion: 0.28
Nodes (5): FormInput(), FormInputProps, RegisterInput, SignUpForm(), metadata
...
Cohesion: 0.19
Nodes (12): PeopleTable(), useAdminUsers(), useDeleteUser(), useRevokeUserSessions(), useSetUserRole(), AdminUserDetail, AdminUserListResult, AdminUserRow (+4 more)
...
## Knowledge Gaps
- **725 isolated node(s):** `$schema`, `plugin`, `@kilocode/plugin`, `AcceptInviteClientProps`, `Props` (+720 more)
...
- **Why does `cn()` connect `Community 1` to `Community 96`, `Community 97`, `Community 67`, `Community 101`, `Community 70`, `Community 104`, `Community 74`, `Community 48`, `Community 82`, `Community 84`, `Community 55`, `Community 86`, `Community 87`, `Community 24`, `Community 89`, `Community 94`, `Community 60`, `Community 62`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 85` to `Community 66`, `Community 12`, `Community 18`, `Community 52`, `Community 88`, `Community 57`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `ok()` connect `Community 85` to `Community 73`, `Community 57`, `Community 66`, `Community 12`?**
