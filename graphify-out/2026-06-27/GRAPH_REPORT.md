...
## Corpus Check
- 307 files · ~104,882 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1693 nodes · 3424 edges · 111 communities (95 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 63 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af7ac397`
...
Cohesion: 0.13
Nodes (20): bulkInviteAdmins(), BulkInviteResult, inviteAdmin(), Tab, sendEmail(), AdminAcceptInviteInput, AdminAcceptInviteSchema, AdminBanUserSchema (+12 more)

### Community 1 - "Community 1"
Cohesion: 0.12
Nodes (27): geistMono, geistSans, inter, metadata, RootLayout(), cn(), Checkbox(), DataTableProps (+19 more)
...
Cohesion: 0.07
Nodes (25): socialSignInAction(), AcceptInviteClient(), AcceptInviteClientProps, metadata, Props, AuthLayout(), AuthLayoutProps, FormButton() (+17 more)
...
Cohesion: 0.13
Nodes (18): bulkInviteRecruiters(), BulkInviteResult, inviteRecruiter(), Tab, BulkEmailsInput, BulkEmailsSchema, authClient, RecruiterAcceptInviteInput (+10 more)
...
Cohesion: 0.10
Nodes (17): GET, handleGET(), GET, handleGET(), GET, handleGET(), MIME_MAP, UPLOAD_DIR (+9 more)

### Community 12 - "Community 12"
Cohesion: 0.19
Nodes (9): AdminUserProfileView(), AdminUserProfileViewProps, useAdminUserApplications(), Props, ApplicationStatus, STATUS_MAP, StatusBadge(), StatusBadgeProps (+1 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (27): EMPLOYMENT_TYPE_OPTIONS, JobForm(), JobFormProps, WORK_MODE_OPTIONS, EMPLOYMENT_TYPE_LABELS, RecruiterJobsTable(), STATUS_BADGE, WORK_MODE_LABELS (+19 more)
...
Cohesion: 0.12
Nodes (22): listJobs(), listJobs(), PeopleTable(), useAdminUsers(), useDeleteUser(), useRevokeUserSessions(), useSetUserRole(), buildOffsetMeta() (+14 more)

### Community 60 - "Community 60"
Cohesion: 0.14
Nodes (17): ApplicantsTable(), ApplicantsTableProps, BULK_ACTION_LABELS, BulkActionDef, NEXT_ACTIONS, STATUS_DOT_COLORS, STATUS_OPTIONS, BulkRejectDialog() (+9 more)
...
Cohesion: 0.17
Nodes (14): createNotification(), createNotificationsBulk(), NotificationInput, triggerForCompany(), adapter, globalForPrisma, pool, getApplicationById() (+6 more)
...
Cohesion: 0.11
Nodes (22): handlePOST(), POST, DELETE, handleDELETE(), DELETE, handleDELETE(), handlePOST(), POST (+14 more)
...
Cohesion: 0.17
Nodes (13): ThreadViewConfig, ThreadViewHooks, AdminThreadView(), config, hooks, Props, MessageItem, MessagesResponse (+5 more)

### Community 71 - "Community 71"
Cohesion: 0.18
Nodes (10): ALLOWED_TRANSITIONS, ApplicationStatusSchema, baseTransitionSchema, BulkStatusTransitionSchema, ListApplicantsParamsSchema, RejectSchema, ScheduleInterviewSchema, SendOfferSchema (+2 more)
...
Cohesion: 0.10
Nodes (19): metadata, AdminDashboard(), CHART_TOOLTIP_STYLE, WORKMODE_COLORS, ActionButton(), ActionButtonProps, capitalizeLabel(), formatLabel() (+11 more)
...
Cohesion: 0.20
Nodes (8): ApiEnvelope, AdminMessagesPage(), ThreadListItem(), ThreadItem, ThreadLastMessage, ThreadUser, useAdminThreads(), formatTime()

### Community 85 - "Community 85"
Cohesion: 0.07
Nodes (44): requireRole(), ResolvedSession, GET, handleGET(), DELETE, handleDELETE(), handlePATCH(), PATCH (+36 more)
...
Cohesion: 0.38
Nodes (5): ApplicantDetailPage(), ApplicantDetailPageProps, NEXT_ACTIONS, useApplicantDetail(), useTransitionStatusWithRefresh()
...
Cohesion: 0.13
Nodes (28): loginAction(), logOutAction(), registerAction(), requestPasswordResetAction(), resetPasswordAction(), { POST, GET }, validateWithZod(), ValidatorResult (+20 more)
...
Cohesion: 0.20
Nodes (11): getSession(), authPages, config, protectedRoutes, proxy(), AuthRedirectTargetType, User, UserCredentials (+3 more)
...
Cohesion: 0.13
Nodes (10): RecruiterMessagesPage(), ThreadListItem(), RecruiterThreadView(), ThreadItem, ThreadLastMessage, ThreadUser, useRecruiterThreads(), SearchResult (+2 more)

### Community 100 - "Community 100"
Cohesion: 0.20
Nodes (8): NotificationItem, NotificationsResponse, apiClient(), ApiResponse, getPusherClient(), DashboardStats, getDashboardStats(), toAbsoluteUrl()

### Community 101 - "Community 101"
Cohesion: 0.15
Nodes (9): AdminApplicantDetailPage(), AdminApplicantDetailPageProps, useAdminApplicantDetail(), ResumePreviewDialog(), Props, STATUS_COLORS, STATUS_ICONS, StatusTimeline() (+1 more)
...
Cohesion: 0.05
Nodes (46): AdminLayoutClient(), AdminLayout(), adminLinks, AdminSidebar(), NotificationDropdown(), NotificationDropdownProps, notificationIconMap, NotificationItem (+38 more)
...
## Knowledge Gaps
- **793 isolated node(s):** `$schema`, `plugin`, `snapshot`, `GET`, `ALLOWED_FILE_TYPES` (+788 more)
...
- **Why does `cn()` connect `Community 1` to `Community 97`, `Community 99`, `Community 101`, `Community 75`, `Community 107`, `Community 13`, `Community 12`, `Community 48`, `Community 112`, `Community 84`, `Community 52`, `Community 55`, `Community 24`, `Community 89`, `Community 60`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 85` to `Community 0`, `Community 96`, `Community 98`, `Community 66`, `Community 9`, `Community 11`, `Community 12`, `Community 47`, `Community 114`, `Community 83`, `Community 54`, `Community 94`, `Community 88`, `Community 57`, `Community 92`, `Community 62`, `Community 95`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `ok()` connect `Community 85` to `Community 65`, `Community 98`, `Community 66`, `Community 73`, `Community 11`, `Community 114`, `Community 83`, `Community 88`, `Community 57`, `Community 92`, `Community 62`?**
