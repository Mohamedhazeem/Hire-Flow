...
## Summary
- 1717 nodes · 3486 edges · 112 communities (96 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 68 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2442da12`
...
Cohesion: 0.18
Nodes (20): cn(), Checkbox(), DataTable(), DataTableProps, DialogOverlay(), SelectGroup(), SelectItem(), SelectLabel() (+12 more)
...
Cohesion: 0.14
Nodes (14): metadata, CHART_TOOLTIP_STYLE, DistributionBarChart(), DistributionBarChartProps, employmentTypeBarData(), filterFromParams(), jobBreakdownColumns, RecruiterAnalyticsPage() (+6 more)
...
Cohesion: 0.09
Nodes (21): GET, handleGET(), GET, handleGET(), GET, handleGET(), GET, handleGET() (+13 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (20): AdminApplicantDetailPage(), AdminApplicantDetailPageProps, recentColumns, RecruiterDashboardProps, AdminUserProfileView(), AdminUserProfileViewProps, useAdminUserApplications(), useAdminApplicantDetail() (+12 more)
...
Cohesion: 0.15
Nodes (18): FunnelChart(), FunnelChartProps, FunnelRow(), FunnelStage, buildWhereClauses(), defaultDateRange(), getAnalytics(), RawCountRow (+10 more)
...
Cohesion: 0.16
Nodes (10): NotificationDropdown(), notificationIconMap, NotificationItem, NotificationsPage(), NotificationsPageProps, NotificationItem, NotificationsResponse, useMarkAsRead() (+2 more)
...
Cohesion: 0.06
Nodes (27): upsertCompany(), metadata, metadata, metadata, metadata, Props, CompanyPage(), metadata (+19 more)
...
Cohesion: 0.09
Nodes (31): DELETE, GET, getOtherUserId(), handleDELETE(), handleGET(), handlePOST(), messageSelect, POST (+23 more)
...
Cohesion: 0.07
Nodes (38): listJobs(), listJobs(), ApplicantsTable(), useApplicants(), useBulkTransitionStatus(), useRevertStatus(), buildOffsetMeta(), CursorPaginationMeta (+30 more)
...
Cohesion: 0.33
Nodes (5): ConflictError, getApplicationById(), ALLOWED_TRANSITIONS, handlePATCH(), PATCH
...
Cohesion: 0.08
Nodes (24): ResolvedSession, DELETE, handleDELETE(), DELETE, handleDELETE(), DELETE, handleDELETE(), GET (+16 more)
...
Cohesion: 0.15
Nodes (14): geistMono, geistSans, inter, metadata, RootLayout(), Providers(), apiClient(), ApiResponse (+6 more)
...
Cohesion: 0.15
Nodes (17): Props, ThreadListItem(), ThreadListItemData, RecruiterMessagesPage(), ThreadListPanel(), UserMessagesPage(), getPusherClient(), AdminMessagesPage() (+9 more)

### Community 85 - "Community 85"
Cohesion: 0.08
Nodes (29): handlePOST(), POST, GET, handleGET(), GET, handleGET(), handlePOST(), POST (+21 more)
...
Cohesion: 0.27
Nodes (8): resend, sendEmail(), SendEmailArgs, env, envSchema, EnvTypes, logger, LogMethods
...
Cohesion: 0.12
Nodes (17): bulkInviteAdmins(), inviteAdmin(), requireRole(), DELETE, handleDELETE(), handlePATCH(), PATCH, GET (+9 more)
...
Cohesion: 0.12
Nodes (11): ApiEnvelope, ThreadItem, ThreadLastMessage, ThreadUser, ThreadItem, ThreadLastMessage, ThreadUser, UserThreadItem (+3 more)

### Community 108 - "Community 108"
Cohesion: 0.16
Nodes (8): AcceptInviteClient(), AcceptInviteClientProps, metadata, Props, authClient, SearchResult, StartConversationSearch(), StartConversationSearchProps
...
Cohesion: 0.09
Nodes (29): AdminLayoutClient(), AdminLayout(), adminLinks, AdminSidebar(), baseRecruiterLinks, RecruiterSidebar(), userLinks, UserSidebar() (+21 more)
...
Cohesion: 0.12
Nodes (18): GET, handleGET(), GET, handleGET(), DELETE, handleDELETE(), handlePOST(), POST (+10 more)
...
## Knowledge Gaps
- **808 isolated node(s):** `Goal`, `Key rules`, `Changed files`, `Step 1 — Extend Pusher auth handler for presence channels`, `Step 2 — Create presence Zustand store` (+803 more)
...
- **Why does `requireRole()` connect `Community 97` to `Community 66`, `Community 98`, `Community 9`, `Community 11`, `Community 114`, `Community 52`, `Community 85`, `Community 94`, `Community 87`, `Community 88`, `Community 57`, `Community 92`, `Community 62`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 1` to `Community 3`, `Community 12`, `Community 13`, `Community 24`, `Community 47`, `Community 48`, `Community 52`, `Community 55`, `Community 59`, `Community 60`, `Community 71`, `Community 74`, `Community 75`, `Community 82`, `Community 83`, `Community 84`, `Community 100`, `Community 108`, `Community 112`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `ok()` connect `Community 114` to `Community 97`, `Community 98`, `Community 66`, `Community 73`, `Community 11`, `Community 85`, `Community 87`, `Community 88`, `Community 57`, `Community 62`?**
...
- **What connects `Goal`, `Key rules`, `Changed files` to the rest of the system?**
