...
## Corpus Check
- 308 files · ~107,019 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1727 nodes · 3515 edges · 107 communities (92 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 68 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `78e8f1f2`
...
9. `auth` - 20 edges
10. `Phase 2: Recruiter Portal – Implementation Guide for AI Agent` - 17 edges
...
Cohesion: 0.05
Nodes (48): listJobs(), listJobs(), PeopleTable(), useAdminUsers(), useDeleteUser(), useRevokeUserSessions(), useSetUserRole(), BulkEmailsInput (+40 more)

### Community 1 - "Community 1"
Cohesion: 0.11
Nodes (29): ActionButton(), ActionButtonProps, capitalizeLabel(), formatLabel(), PeopleTableProps, ROLE_OPTIONS, UserRow, UsersApiResponse (+21 more)
...
Cohesion: 0.19
Nodes (11): BulkInviteResult, metadata, InviteRecruiterForm(), Tab, RecruiterTeamList(), InviteListResponse, RecruiterInvite, RecruiterTeamMember (+3 more)
...
Cohesion: 0.11
Nodes (26): bulkInviteAdmins(), inviteAdmin(), inviteRecruiter(), SocialProvider, { POST, GET }, ResolvedSession, handlePOST(), POST (+18 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (19): metadata, Props, AdminApplicantDetailRoute(), AdminApplicantDetailPage(), AdminApplicantDetailPageProps, recentColumns, RecruiterDashboardProps, useAdminApplicantDetail() (+11 more)
...
Cohesion: 0.05
Nodes (58): loginAction(), logOutAction(), registerAction(), requestPasswordResetAction(), resetPasswordAction(), socialSignInAction(), AuthLayout(), AuthLayoutProps (+50 more)
...
Cohesion: 0.11
Nodes (34): AdminJobsTable(), AdminJobsTableProps, EMPLOYMENT_TYPE_LABELS, WORK_MODE_LABELS, BanDialog(), BanDialogProps, BulkRejectDialogProps, RevertDialogProps (+26 more)
...
Cohesion: 0.08
Nodes (36): ApplicantDetailPage(), ApplicantDetailPageProps, NEXT_ACTIONS, ApplicantsTable(), ApplicantsTableProps, BULK_ACTION_LABELS, BulkActionDef, NEXT_ACTIONS (+28 more)
...
Cohesion: 0.08
Nodes (26): DELETE, handleDELETE(), DELETE, handleDELETE(), DELETE, handleDELETE(), DELETE, handleDELETE() (+18 more)
...
Cohesion: 0.12
Nodes (18): ThreadListItemData, AdminThreadView(), config, hooks, Props, ApiEnvelope, AdminMessagesPage(), MessageItem (+10 more)
...
Cohesion: 0.14
Nodes (11): JobDetail(), JobDetailProps, STATUS_BADGE, TABS, PageProps, apiClient(), ApiResponse, SearchResult (+3 more)

### Community 84 - "Community 84"
Cohesion: 0.19
Nodes (9): Props, ThreadListItem(), RecruiterMessagesPage(), ThreadItem, ThreadLastMessage, ThreadUser, useRecruiterThreads(), useOwnPresence() (+1 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (47): bulkInviteRecruiters(), requireRole(), GET, handleGET(), DELETE, handleDELETE(), handlePATCH(), PATCH (+39 more)

### Community 86 - "Community 86"
Cohesion: 0.17
Nodes (12): metadata, CHART_TOOLTIP_STYLE, DistributionBarChart(), DistributionBarChartProps, employmentTypeBarData(), filterFromParams(), jobBreakdownColumns, RecruiterAnalyticsPage() (+4 more)
...
Cohesion: 0.18
Nodes (11): ThreadListPanel(), UserMessagesPage(), getPusherClient(), ThreadListPanel(), UserThreadItem, UserThreadLastMessage, UserThreadUser, useUserThreads() (+3 more)
...
Cohesion: 0.15
Nodes (10): Props, metadata, CHART_TOOLTIP_STYLE, TrendChart(), TrendChartProps, filterFromParams(), PerJobAnalyticsPage(), PerJobAnalyticsPageProps (+2 more)
...
Cohesion: 0.06
Nodes (38): AdminLayoutClient(), AcceptInviteClient(), AcceptInviteClientProps, metadata, Props, AdminLayout(), adminLinks, AdminSidebar() (+30 more)
...
## Knowledge Gaps
- **818 isolated node(s):** `Role Guard Requirement`, `STATE & CACHE RULES (short)`, `Phase 2 & 3`, `Stack`, `Absolute Rules` (+813 more)
...
- **Why does `cn()` connect `Community 1` to `Community 70`, `Community 74`, `Community 12`, `Community 109`, `Community 13`, `Community 48`, `Community 112`, `Community 82`, `Community 83`, `Community 84`, `Community 52`, `Community 86`, `Community 55`, `Community 51`, `Community 89`, `Community 59`, `Community 60`, `Community 95`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `env` connect `Community 11` to `Community 65`, `Community 47`, `Community 112`, `Community 50`, `Community 83`, `Community 89`, `Community 58`, `Community 57`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 85` to `Community 98`, `Community 66`, `Community 71`, `Community 9`, `Community 11`, `Community 12`, `Community 114`, `Community 88`, `Community 57`, `Community 94`?**
