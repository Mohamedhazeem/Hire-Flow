...
## Corpus Check
- 500 files · ~174,960 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2961 nodes · 5441 edges · 179 communities (161 shown, 18 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 70 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `01213ae2`
...
1. `requireRole()` - 126 edges
2. `ok()` - 109 edges
3. `cn()` - 99 edges
4. `withErrorHandler()` - 60 edges
5. `Phase 2: Recruiter` - 59 edges
6. `ValidationError` - 50 edges
7. `apiClient()` - 41 edges
8. `Button()` - 40 edges
9. `NotFoundError` - 39 edges
...
Cohesion: 0.06
Nodes (40): saveResumeBuilder(), metadata, metadata, AiSuggestionsPanel(), AiSuggestionsPanelProps, priorityColors, scoreColor(), typeLabels (+32 more)
...
Cohesion: 0.11
Nodes (27): GET, DELETE, GET, handleDELETE(), handleGET(), handlePOST(), POST, ConflictError (+19 more)
...
Cohesion: 0.10
Nodes (26): inviteAdmin(), inviteRecruiter(), SocialProvider, { POST, GET }, DELETE, DELETE, POST, GET (+18 more)
...
Cohesion: 0.09
Nodes (18): metadata, ActionButton(), ActionButtonProps, capitalizeLabel(), formatLabel(), PeopleTable(), PeopleTableProps, ROLE_OPTIONS (+10 more)
...
Cohesion: 0.10
Nodes (22): metadata, EMPLOYMENT_TYPE_OPTIONS, JobForm(), JobFormProps, WORK_MODE_OPTIONS, EMPLOYMENT_TYPE_LABELS, RecruiterJobsTable(), STATUS_BADGE (+14 more)
...
Cohesion: 0.16
Nodes (22): BanDialog(), BanDialogProps, BulkRejectDialogProps, RevertDialogProps, useBanUser(), useUnbanUser(), ConfirmDialogProps, VARIANT_BUTTON (+14 more)
...
Cohesion: 0.12
Nodes (28): AdminJobsTableProps, EMPLOYMENT_TYPE_LABELS, WORK_MODE_LABELS, ApplicantTableFeedback(), FeedbackProps, ApplicantTableToolbarProps, cn(), Checkbox() (+20 more)
...
Cohesion: 0.07
Nodes (23): GET, handleGET(), GET(), Props, GET, handleGET(), AdminUserDetailPage(), adapter (+15 more)
...
Cohesion: 0.10
Nodes (17): metadata, Props, ApplicantTableColumnsProps, createApplicantTableColumns(), ApplicantTablePagination(), ApplicantTablePaginationProps, ApplicantTableToolbar(), ApplicantsTable() (+9 more)
...
Cohesion: 0.13
Nodes (15): GET, handleGET(), generateMetadata(), FeaturedJobs(), FeaturedJobsGrid(), JobDetailView(), buildJobJsonLd(), ALLOWED_SORT_FIELDS (+7 more)
...
Cohesion: 0.19
Nodes (9): MessagesPageConfig, Props, ThreadListItem(), ThreadListItemData, AdminMessagesPage(), config, AdminThreadView(), useAdminThreads (+1 more)

### Community 70 - "Community 70"
Cohesion: 0.20
Nodes (14): POST(), ChatHeader(), ChatHeaderProps, MessageItem, Props, SharedThreadView(), ThreadViewConfig, ThreadViewHooks (+6 more)
...
Cohesion: 0.28
Nodes (7): BULK_ACTION_LABELS, BulkActionDef, NEXT_ACTIONS, STATUS_DOT_COLORS, STATUS_OPTIONS, addActionedIds(), getBulkActions()
...
Cohesion: 0.10
Nodes (21): POST, handlePOST(), POST, fail(), ERROR_STATUS_MAP, handleError(), ParamHandler, RouteContext (+13 more)

### Community 96 - "Community 96"
Cohesion: 0.10
Nodes (20): metadata, metadata, AdminDashboard(), CHART_TOOLTIP_STYLE, WORKMODE_COLORS, AdminTeamList(), InviteAdminForm(), recentColumns (+12 more)
...
Cohesion: 0.05
Nodes (59): applyAiSuggestions(), bulkInviteAdmins(), bulkInviteRecruiters(), requireRole(), GET, handleGET(), GET, handleGET() (+51 more)
...
Cohesion: 0.07
Nodes (30): ResolvedSession, { DELETE }, GET, handleGET(), { DELETE }, { DELETE }, { GET, POST, DELETE }, { GET } (+22 more)
...
Cohesion: 0.60
Nodes (4): AdminJobsTable(), useAdminJobs(), useDeleteJob(), useToggleJobStatus()
...
Cohesion: 0.19
Nodes (12): ResetPasswordSchema, ActionResult, AuthRedirectTargetType, AuthType, ForgotPasswordType, LoginInputType, RegisterInputType, ResetPasswordType (+4 more)
...
Cohesion: 0.11
Nodes (15): DELETE, handleDELETE(), GET, handleGET(), PATCH, checkRateLimit(), DEFAULT_CONFIG, RateLimitConfig (+7 more)
...
## Knowledge Gaps
- **1558 isolated node(s):** `{ DELETE }`, `POST`, `GET`, `DELETE`, `PATCH` (+1553 more)
...
- **Why does `cn()` connect `Community 40` to `Community 18`, `Community 24`, `Community 28`, `Community 30`, `Community 36`, `Community 38`, `Community 49`, `Community 50`, `Community 51`, `Community 66`, `Community 69`, `Community 74`, `Community 75`, `Community 88`, `Community 94`, `Community 96`, `Community 106`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 103` to `Community 102`, `Community 171`, `Community 172`, `Community 43`, `Community 111`, `Community 19`, `Community 55`, `Community 86`, `Community 87`, `Community 22`, `Community 54`, `Community 26`, `Community 155`, `Community 28`, `Community 29`, `Community 94`, `Community 95`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 38` to `Community 96`, `Community 34`, `Community 66`, `Community 37`, `Community 40`, `Community 109`, `Community 92`, `Community 50`, `Community 19`, `Community 94`, `Community 21`, `Community 86`, `Community 23`, `Community 25`, `Community 28`, `Community 29`, `Community 30`?**
...
- **What connects `{ DELETE }`, `POST`, `GET` to the rest of the system?**
