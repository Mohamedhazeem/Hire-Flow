...
## Corpus Check
- 457 files · ~170,593 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2847 nodes · 5103 edges · 167 communities (152 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 76 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7ac316d3`
...
- `handleDELETE()` --calls--> `ok()`  [INFERRED]
  app/api/user/applications/[id]/route.ts → lib/api-response.ts
- `handleDELETE()` --calls--> `ok()`  [INFERRED]
  app/api/user/resumes/[id]/route.ts → lib/api-response.ts
- `handleDELETE()` --calls--> `ok()`  [INFERRED]
...
Cohesion: 0.05
Nodes (61): requireRole(), GET, handleGET(), DELETE, handleDELETE(), handlePATCH(), PATCH, GET (+53 more)
...
Cohesion: 0.08
Nodes (27): handlePOST(), POST, handlePOST(), POST, GET, handleGET(), GET, UnauthorizedError (+19 more)

### Community 22 - "Community 22"
Cohesion: 0.09
Nodes (27): DELETE, GET, handleDELETE(), handleGET(), handlePOST(), POST, ConflictError, NotFoundError (+19 more)

### Community 23 - "Community 23"
Cohesion: 0.10
Nodes (28): BULK_ACTION_LABELS, BulkActionDef, NEXT_ACTIONS, STATUS_DOT_COLORS, STATUS_OPTIONS, addActionedIds(), getBulkActions(), BulkActionBar() (+20 more)
...
Cohesion: 0.06
Nodes (37): applyAiSuggestions(), saveResumeBuilder(), ResolvedSession, DELETE, handleDELETE(), GET, handleGET(), DELETE (+29 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (28): AuthLayout(), AuthLayoutProps, DustParticle(), hashToFloat(), FormButton(), FormButtonProps, FormInput(), FormInputProps (+20 more)
...
Cohesion: 0.11
Nodes (22): JobForm(), EMPLOYMENT_TYPE_LABELS, RecruiterJobsTable(), STATUS_BADGE, WORK_MODE_LABELS, PageProps, useCreateJob(), useDeleteJob() (+14 more)
...
Cohesion: 0.10
Nodes (30): ApplicantTablePaginationProps, BanDialog(), BanDialogProps, BulkRejectDialogProps, RevertDialogProps, AdminUserProfileView(), AdminUserProfileViewProps, useAdminUserApplications() (+22 more)
...
Cohesion: 0.14
Nodes (24): FilterButton(), FilterButtonProps, cn(), Checkbox(), DataTable(), DataTableProps, DateRangePicker(), DateRangePickerProps (+16 more)
...
Cohesion: 0.23
Nodes (11): ChatHeader(), ChatHeaderProps, MessageItem, Props, SharedThreadView(), ThreadViewConfig, ThreadViewHooks, usePusherThread() (+3 more)
...
Cohesion: 0.11
Nodes (19): MessagesPageConfig, MessagesPageLayout(), Props, ThreadListPanel(), Props, ThreadListItem(), ThreadListItemData, AdminMessagesPage() (+11 more)

### Community 67 - "Community 67"
Cohesion: 0.12
Nodes (13): metadata, Props, ApplicantTableColumnsProps, createApplicantTableColumns(), ApplicantTableFeedback(), FeedbackProps, ApplicantTablePagination(), ApplicantsTable() (+5 more)
...
Cohesion: 0.11
Nodes (25): ChatInputAreaProps, AdminJobsTable(), AdminJobsTableProps, EMPLOYMENT_TYPE_LABELS, WORK_MODE_LABELS, ApplicantTableToolbar(), ApplicantTableToolbarProps, EMPLOYMENT_TYPE_OPTIONS (+17 more)

### Community 80 - "Community 80"
Cohesion: 0.11
Nodes (22): listJobs(), listJobs(), buildOffsetMeta(), CursorPaginationMeta, CursorPaginationParams, OffsetPaginationMeta, OffsetPaginationParams, parseOffsetParams() (+14 more)
...
Cohesion: 0.26
Nodes (9): recruiterLinks, userLinks, UserSidebar(), getSidebarDisplayName(), Sidebar(), SidebarLink, SidebarProps, SidebarUser (+1 more)
...
Cohesion: 0.18
Nodes (8): geistMono, geistSans, inter, metadata, RootLayout(), Providers(), Theme, ThemeInitializer()

### Community 93 - "Community 93"
Cohesion: 0.23
Nodes (9): generateMetadata(), ApplyModal(), ApplyModalProps, ResumeOption, fmtSalary(), JobDetailView(), buildJobJsonLd(), getPublicJobById() (+1 more)
...
Cohesion: 0.13
Nodes (15): metadata, InviteRecruiterForm(), JobDetailProps, STATUS_BADGE, TABS, RecruiterTeamList(), InviteListResponse, RecruiterInvite (+7 more)
...
Cohesion: 0.23
Nodes (8): AdminLayout(), RecruiterSidebar(), RoleLayoutClient(), RecruiterLayout(), RecruiterLayoutClient(), UserLayout(), UserLayoutClient(), checkRole()
...
Cohesion: 0.18
Nodes (9): FeaturedJobs(), GET, ALLOWED_SORT_FIELDS, ALLOWED_SORT_ORDERS, listPublicJobs(), PublicJobDetail, PublicJobListParams, PublicJobListResult (+1 more)
...
Cohesion: 0.24
Nodes (9): config, hooks, Props, MessageItem, MessagesResponse, SendMessagePayload, useDeleteUserMessage(), useSendUserMessage() (+1 more)
...
Cohesion: 0.13
Nodes (14): handlePOST(), POST, GET, handleGET(), GET, handleGET(), AIProvider, callAI() (+6 more)

### Community 110 - "Community 110"
Cohesion: 0.36
Nodes (5): AdminLayoutClient(), adminLinks, AdminSidebar(), LogoutButton(), useSignOut()
...
Cohesion: 0.36
Nodes (5): MobileMenuButton(), RoleLayoutClientProps, PersistedState, UIStore, useUIStore
...
## Knowledge Gaps
- **1529 isolated node(s):** `FilterSelectProps`, `WORK_MODES`, `EMPLOYMENT_TYPES`, `EXPERIENCE_LEVELS`, `STATUS_OPTIONS` (+1524 more)
