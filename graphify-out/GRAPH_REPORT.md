...
## Corpus Check
- 458 files · ~170,614 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2848 nodes · 5127 edges · 172 communities (156 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 83 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `62d8259d`
...
Cohesion: 0.06
Nodes (67): requireRole(), ResolvedSession, GET, handleGET(), DELETE, handleDELETE(), handlePATCH(), PATCH (+59 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (55): Props, metadata, metadata, CHART_TOOLTIP_STYLE, DistributionBarChart(), DistributionBarChartProps, FunnelChart(), FunnelChartProps (+47 more)
...
Cohesion: 0.05
Nodes (43): bulkInviteAdmins(), bulkInviteRecruiters(), BulkInviteResult, inviteAdmin(), inviteRecruiter(), SocialProvider, { POST, GET }, DELETE (+35 more)

### Community 22 - "Community 22"
Cohesion: 0.08
Nodes (26): DELETE, GET, handleDELETE(), handleGET(), handlePOST(), POST, ConflictError, TooManyRequestsError (+18 more)

### Community 23 - "Community 23"
Cohesion: 0.15
Nodes (21): BULK_ACTION_LABELS, BulkActionDef, NEXT_ACTIONS, addActionedIds(), useApplicantsTable(), useApplicants(), useBulkTransitionStatus(), useRevertStatus() (+13 more)
...
Cohesion: 0.06
Nodes (35): applyAiSuggestions(), saveResumeBuilder(), handlePOST(), POST, DELETE, handleDELETE(), DELETE, handleDELETE() (+27 more)
...
Cohesion: 0.14
Nodes (14): metadata, Props, AdminApplicantDetailRoute(), AdminApplicantDetailPage(), AdminApplicantDetailPageProps, useAdminApplicantDetail(), ApplicantResumeCard(), ApplicantResumeCardProps (+6 more)
...
Cohesion: 0.14
Nodes (19): listJobs(), listJobs(), buildOffsetMeta(), CursorPaginationMeta, CursorPaginationParams, OffsetPaginationMeta, OffsetPaginationParams, parseOffsetParams() (+11 more)
...
Cohesion: 0.14
Nodes (20): LoginActionInput, LoginActionSchema, disposableSet, emailSchema, ForgotPasswordSchema, PasswordSchema, SignInSchema, SignUpSchema (+12 more)

### Community 37 - "Community 37"
Cohesion: 0.11
Nodes (16): apiClient(), ApiResponse, DEFAULT_QUERY_OPTIONS, defaultQueryFn(), getQueryClient(), makeQueryClient(), QueryKeyShape, ThreadItem (+8 more)

### Community 38 - "Community 38"
Cohesion: 0.15
Nodes (22): BanDialogProps, BulkRejectDialogProps, RevertDialogProps, ConfirmActionButtonProps, ConfirmDialog(), ConfirmDialogProps, ConfirmDialogVariant, VARIANT_BUTTON (+14 more)
...
Cohesion: 0.10
Nodes (32): ChatInputAreaProps, STATUS_DOT_COLORS, STATUS_OPTIONS, ApplicantTableFeedback(), FeedbackProps, ApplicantTableToolbar(), ApplicantTableToolbarProps, computeThreadId() (+24 more)
...
Cohesion: 0.13
Nodes (17): BulkInviteResult, Tab, BulkEmailsInput, BulkEmailsSchema, AdminAcceptInviteInput, AdminAcceptInviteSchema, AdminBanUserSchema, AdminBulkInviteFormInput (+9 more)
...
Cohesion: 0.11
Nodes (14): metadata, ApplicantTableColumnsProps, createApplicantTableColumns(), ApplicationHeader(), Props, ApplicationsPage(), AppRow, STATUSES (+6 more)
...
Cohesion: 0.13
Nodes (20): ChatHeader(), ChatHeaderProps, MessageItem, Props, SharedThreadView(), ThreadViewConfig, ThreadViewHooks, usePusherThread() (+12 more)
...
Cohesion: 0.21
Nodes (11): metadata, AdminJobsTable(), AdminJobsTableProps, EMPLOYMENT_TYPE_LABELS, WORK_MODE_LABELS, useAdminJobs(), useDeleteJob(), useToggleJobStatus() (+3 more)
...
Cohesion: 0.28
Nodes (5): ResetPasswordForm(), ResetPasswordInput, metadata, ResetPasswordSchema, ResetPasswordType

### Community 93 - "Community 93"
Cohesion: 0.24
Nodes (8): generateMetadata(), ApplyModal(), ApplyModalProps, ResumeOption, JobDetailView(), buildJobJsonLd(), getPublicJobById(), Skeleton()

### Community 94 - "Community 94"
Cohesion: 0.17
Nodes (10): JobDetailProps, STATUS_BADGE, TABS, AdminUserProfileView(), AdminUserProfileViewProps, useAdminUserApplications(), RecruiterJobDetail, ResumePreviewDialog() (+2 more)

### Community 95 - "Community 95"
Cohesion: 0.10
Nodes (22): handlePOST(), POST, handlePOST(), POST, fail(), ERROR_STATUS_MAP, handleError(), ParamHandler (+14 more)
...
Cohesion: 0.23
Nodes (8): AdminLayoutClient(), AdminLayout(), RoleLayoutClient(), RecruiterLayout(), RecruiterLayoutClient(), UserLayout(), UserLayoutClient(), checkRole()
...
Cohesion: 0.21
Nodes (7): config, UserMessagesPage(), UserThreadView(), UserThreadItem, UserThreadLastMessage, UserThreadUser, useUserThreads()
...
Cohesion: 0.17
Nodes (12): metadata, AdminTeamList(), ApplicationActions(), Props, InviteAdminForm(), AdminInvite, AdminTeamMember, InviteListResponse (+4 more)
...
Cohesion: 0.18
Nodes (10): metadata, Props, ApplicantDetailDialogs(), ApplicantDetailPage(), ApplicantDetailPageProps, ApplicantDetailSkeleton(), useApplicantDetail(), useTransitionStatusWithRefresh() (+2 more)
...
- **Why does `cn()` connect `Community 40` to `Community 89`, `Community 66`, `Community 67`, `Community 70`, `Community 38`, `Community 74`, `Community 109`, `Community 110`, `Community 49`, `Community 18`, `Community 51`, `Community 30`, `Community 55`, `Community 119`, `Community 88`, `Community 25`, `Community 28`, `Community 94`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 17` to `Community 103`, `Community 43`, `Community 112`, `Community 19`, `Community 21`, `Community 86`, `Community 87`, `Community 22`, `Community 54`, `Community 26`, `Community 55`, `Community 28`, `Community 29`, `Community 95`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `apiClient()` connect `Community 37` to `Community 18`, `Community 19`, `Community 23`, `Community 155`, `Community 28`, `Community 30`, `Community 34`, `Community 40`, `Community 42`, `Community 51`, `Community 55`, `Community 65`, `Community 67`, `Community 74`, `Community 75`, `Community 79`, `Community 82`, `Community 86`, `Community 93`, `Community 94`, `Community 96`, `Community 104`, `Community 105`, `Community 107`, `Community 113`, `Community 125`?**
