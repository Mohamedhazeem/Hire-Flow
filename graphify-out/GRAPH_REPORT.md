...
## Corpus Check
- 311 files · ~106,378 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1717 nodes · 3494 edges · 121 communities (105 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 68 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b7c5c10f`
...
Cohesion: 0.21
Nodes (15): cn(), Checkbox(), DataTableProps, DialogOverlay(), StatCard(), StatCardProps, Table(), TableBody() (+7 more)
...
Cohesion: 0.09
Nodes (19): DELETE, handleDELETE(), GET, handleGET(), GET, handleGET(), GET, handleGET() (+11 more)

### Community 12 - "Community 12"
Cohesion: 0.10
Nodes (18): AdminApplicantDetailPageProps, JobDetailProps, STATUS_BADGE, TABS, recentColumns, RecruiterDashboardProps, AdminUserProfileView(), AdminUserProfileViewProps (+10 more)
...
Cohesion: 0.13
Nodes (8): metadata, metadata, Props, PageHeader(), PageHeaderProps, metadata, Props, metadata
...
Cohesion: 0.16
Nodes (16): listJobs(), buildOffsetMeta(), CursorPaginationMeta, CursorPaginationParams, OffsetPaginationMeta, OffsetPaginationParams, parseOffsetParams(), listApplicants() (+8 more)

### Community 60 - "Community 60"
Cohesion: 0.09
Nodes (30): ApplicantDetailPageProps, NEXT_ACTIONS, ApplicantsTable(), ApplicantsTableProps, BULK_ACTION_LABELS, BulkActionDef, NEXT_ACTIONS, STATUS_DOT_COLORS (+22 more)
...
Cohesion: 0.11
Nodes (17): ResolvedSession, DELETE, handleDELETE(), DELETE, handleDELETE(), DELETE, handleDELETE(), GET (+9 more)
...
Cohesion: 0.17
Nodes (13): ApplicantListResult, ApplicationStatusSchema, baseTransitionSchema, BulkStatusTransitionInput, BulkStatusTransitionSchema, ListApplicantsParams, ListApplicantsParamsSchema, RejectSchema (+5 more)
...
Cohesion: 0.28
Nodes (7): ApplicantDetailPage(), useApplicantDetail(), useTransitionStatusWithRefresh(), ApplicantDetailResponse, DeletedResume, ResumeInfo, STATUS_LABELS
...
Cohesion: 0.12
Nodes (24): AdminJobsTableProps, EMPLOYMENT_TYPE_LABELS, WORK_MODE_LABELS, EMPLOYMENT_TYPE_LABELS, STATUS_BADGE, WORK_MODE_LABELS, ConfirmActionButton(), ConfirmActionButtonProps (+16 more)
...
Cohesion: 0.14
Nodes (27): loginAction(), registerAction(), requestPasswordResetAction(), resetPasswordAction(), validateWithZod(), ValidatorResult, verifyUserStatus(), HEADERS (+19 more)
...
Cohesion: 0.17
Nodes (12): logOutAction(), SocialProvider, { POST, GET }, auth, resend, SendEmailArgs, UserStatusResult, env (+4 more)
...
Cohesion: 0.22
Nodes (8): authPages, config, protectedRoutes, proxy(), RoleSchema, RoleType, getRedirectPath(), VerifyEmailPage()
...
Cohesion: 0.14
Nodes (16): bulkInviteAdmins(), inviteAdmin(), requireRole(), DELETE, handleDELETE(), handlePATCH(), PATCH, GET (+8 more)
...
Cohesion: 0.17
Nodes (8): RecruiterMessagesPage(), ThreadItem, ThreadLastMessage, ThreadUser, useRecruiterThreads(), SearchResult, StartConversationSearch(), StartConversationSearchProps
...
Cohesion: 0.25
Nodes (4): Props, STATUS_COLORS, STATUS_ICONS, StatusTimelineEntry
...
Cohesion: 0.14
Nodes (9): GET, handleGET(), GET, handleGET(), adapter, globalForPrisma, pool, GET (+1 more)
...
Cohesion: 0.17
Nodes (8): ApiEnvelope, ThreadItem, ThreadLastMessage, ThreadUser, UserThreadItem, UserThreadLastMessage, UserThreadUser, useUserThreads()
...
Cohesion: 0.24
Nodes (7): EMPLOYMENT_TYPE_OPTIONS, JobForm(), JobFormProps, WORK_MODE_OPTIONS, useCreateJob(), useUpdateJob(), metadata
...
Cohesion: 0.05
Nodes (48): AdminLayoutClient(), AdminLayout(), adminLinks, AdminSidebar(), NotificationDropdown(), NotificationDropdownProps, notificationIconMap, NotificationItem (+40 more)
...
Cohesion: 0.11
Nodes (19): GET, handleGET(), DELETE, handleDELETE(), DELETE, GET, handleDELETE(), handleGET() (+11 more)

### Community 115 - "Community 115"
Cohesion: 0.28
Nodes (5): metadata, RecruiterJobsTable(), useDeleteJob(), useRecruiterJobs(), useToggleJobStatus()
...
## Knowledge Gaps
- **808 isolated node(s):** `$schema`, `plugin`, `snapshot`, `@kilocode/plugin`, `AcceptInviteClientProps` (+803 more)
...
- **Why does `cn()` connect `Community 1` to `Community 99`, `Community 101`, `Community 75`, `Community 12`, `Community 48`, `Community 112`, `Community 82`, `Community 84`, `Community 52`, `Community 55`, `Community 87`, `Community 24`, `Community 60`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 97` to `Community 96`, `Community 66`, `Community 98`, `Community 9`, `Community 105`, `Community 11`, `Community 47`, `Community 114`, `Community 85`, `Community 94`, `Community 88`, `Community 57`, `Community 92`, `Community 62`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `ok()` connect `Community 114` to `Community 97`, `Community 98`, `Community 66`, `Community 65`, `Community 105`, `Community 73`, `Community 11`, `Community 85`, `Community 88`, `Community 57`, `Community 62`?**
