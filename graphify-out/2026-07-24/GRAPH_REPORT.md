...
## Corpus Check
- 669 files · ~283,207 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3504 nodes · 6553 edges · 217 communities (180 shown, 37 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 77 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0bde6524`
...
Cohesion: 0.08
Nodes (34): ApplicantTableToolbar(), ApplicantTableToolbarProps, EMPLOYMENT_TYPE_LABELS, JobTableToolbar(), JobTableToolbarProps, WORK_MODE_LABELS, createPeopleTableColumns(), PeopleTable() (+26 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (50): listJobs(), listJobs(), generateMetadata(), JobDetailPage(), PageProps, CompactJobCard(), formatSalary(), CompanyJobsPanel() (+42 more)
...
Cohesion: 0.07
Nodes (33): metadata, EMPLOYMENT_TYPE_OPTIONS, JobForm(), JobFormProps, WORK_MODE_OPTIONS, Actions, createRecruiterJobColumns(), STATUS_BADGE (+25 more)
...
Cohesion: 0.13
Nodes (8): AcceptInviteClient(), AcceptInviteClientProps, metadata, Props, AccountPopover(), mockSignOut, SessionResult, authClient
...
Cohesion: 0.06
Nodes (51): applyAiSuggestions(), ok(), requireRole(), GET, handleGET(), DELETE, handleDELETE(), handlePATCH() (+43 more)
...
Cohesion: 0.15
Nodes (15): MessagesPageConfig, MessagesPageLayout(), Props, ThreadListPanel(), config, RecruiterMessagesPage(), RecruiterThreadView(), useRecruiterThreads (+7 more)
...
Cohesion: 0.06
Nodes (53): geistMono, geistSans, inter, metadata, RootLayout(), Providers(), LINKS, ROLE_META (+45 more)
...
Cohesion: 0.14
Nodes (12): A full-stack, multi-tenant hiring platform built for scale, 🏛️ Architecture & Design Decisions, 📬 Contact, 📡 Core API Endpoints, ☁️ Deployment, 🚀 Hire Flow, 🧩 Key Patterns, 📄 License (+4 more)
...
Cohesion: 0.06
Nodes (31): ActivityPanel(), AppRow, statConfig, Stats, ApplyModal(), ApplyModalProps, mockPush, mutationState (+23 more)
...
Cohesion: 0.08
Nodes (27): apiClient(), ApiResponse, DEFAULT_QUERY_OPTIONS, defaultQueryFn(), getQueryClient(), makeQueryClient(), QueryKeyShape, mockPush (+19 more)
...
Cohesion: 0.06
Nodes (40): metadata, metadata, AdminJobsTable(), AdminJobsTableProps, AdminTeamList(), ApplicationActions(), Props, columns (+32 more)
...
Cohesion: 0.06
Nodes (34): SocialProvider, socialSignInAction(), AuthCard(), Props, AuthLayout(), Props, FormButton(), FormButtonProps (+26 more)
...
Cohesion: 0.10
Nodes (29): loginAction(), LoginActionInput, LoginActionSchema, logOutAction(), registerAction(), requestPasswordResetAction(), resetPasswordAction(), { POST, GET } (+21 more)

### Community 80 - "Community 80"
Cohesion: 0.10
Nodes (17): { GET, POST, DELETE }, { GET }, { GET, POST, DELETE }, { GET }, createThreadIdMessageHandlers(), createThreadListHandler(), MessageIdHandlerOptions, ThreadIdHandlerOptions (+9 more)
...
Cohesion: 0.05
Nodes (41): upsertCompany(), upsertProfile(), CompanyPage(), metadata, CompanyForm(), CompanyFormProps, emptyExperience, ExperienceListEditor() (+33 more)
...
Cohesion: 0.20
Nodes (8): inter, metadata, newFunction(), NotFound(), JobDetailPage(), PageProps, AdminRecruiterDetailPage(), EditBuilderPage()
...
Cohesion: 0.11
Nodes (10): metadata, metadata, ApplicationsPage(), AppRow, STATUSES, PageHeader(), PageHeaderProps, metadata (+2 more)
...
Cohesion: 0.18
Nodes (8): Props, AdminRecruiterProfileView(), AdminRecruiterProfileViewProps, CompanyJob, CompanyCard(), CompanyCardProps, IconBox(), IconBoxProps
...
Cohesion: 0.12
Nodes (26): BulkActionBar(), BulkActionBarProps, useApplicantsTable(), useApplicants(), useBulkTransitionStatus(), useRevertStatus(), ApplicantListResult, ApplicantRow (+18 more)
...
Cohesion: 0.14
Nodes (10): metadata, Props, ApplicantTablePagination(), ApplicantTablePaginationProps, ApplicantsTable(), ApplicantsTableProps, ApplicantsTableDialogs(), capturedArgs (+2 more)
...
Cohesion: 0.07
Nodes (33): fail(), ERROR_STATUS_MAP, handleError(), ParamHandler, RouteContext, SimpleHandler, withErrorHandler(), handlePOST() (+25 more)
...
## Knowledge Gaps
- **1733 isolated node(s):** `A full-stack, multi-tenant hiring platform built for scale`, `🧱 Tech Stack`, `🛡️ Admin`, `🏢 Recruiter`, `👤 Job Seeker (User)` (+1728 more)
...
- **Why does `cn()` connect `Community 42` to `Community 140`, `Community 18`, `Community 25`, `Community 26`, `Community 27`, `Community 34`, `Community 38`, `Community 49`, `Community 50`, `Community 51`, `Community 182`, `Community 55`, `Community 61`, `Community 66`, `Community 67`, `Community 83`, `Community 88`, `Community 93`, `Community 94`, `Community 95`, `Community 96`, `Community 106`, `Community 117`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 30` to `Community 149`, `Community 21`, `Community 22`, `Community 35`, `Community 169`, `Community 170`, `Community 172`, `Community 65`, `Community 66`, `Community 74`, `Community 208`, `Community 80`, `Community 83`, `Community 86`, `Community 87`, `Community 89`, `Community 95`, `Community 107`, `Community 111`, `Community 118`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `env` connect `Community 169` to `Community 33`, `Community 34`, `Community 35`, `Community 75`, `Community 79`, `Community 92`, `Community 83`, `Community 180`, `Community 148`, `Community 28`?**
