...
- `handlePOST()` --calls--> `fail()` [INFERRED]
...
Cohesion: 0.07
Nodes (34): listJobs(), listJobs(), mocks, buildCursorMeta(), buildOffsetMeta(), CursorPaginationMeta, CursorPaginationParams, OffsetPaginationMeta (+26 more)
...
Cohesion: 0.11
Nodes (16): DisabledJobCard(), DisabledJobCardProps, mockPush, mockState, SessionResult, SaveJobButton(), SaveJobButtonProps, SavedJobData (+8 more)
...
Cohesion: 0.16
Nodes (9): InviteSingleForm(), mockApiClient, testResults, CommaInput(), CommaInputProps, SearchResult, StartConversationSearch(), StartConversationSearchProps (+1 more)
...
Cohesion: 0.07
Nodes (20): metadata, metadata, metadata, ApplicantTableColumnsProps, createApplicantTableColumns(), Props, ApplicationsPage(), AppRow (+12 more)
...
Cohesion: 0.24
Nodes (8): ApplicantTableToolbar(), ApplicantTableToolbarProps, BulkActionBar(), BulkActionBarProps, BULK_ACTION_LABELS, BulkActionDef, STATUS_DOT_COLORS, STATUS_OPTIONS
...
Cohesion: 0.07
Nodes (34): Props, metadata, FunnelChart(), FunnelChartProps, FunnelRow(), FunnelStage, CHART_TOOLTIP_STYLE, TrendChart() (+26 more)
...
Cohesion: 0.26
Nodes (11): useApplicantsTable(), useApplicants(), useBulkTransitionStatus(), useRevertStatus(), ApplicantListResult, ApplicantRow, BulkStatusTransitionInput, ListApplicantsParams (+3 more)
...
Cohesion: 0.13
Nodes (11): metadata, Props, ApplicantTableFeedback(), FeedbackProps, ApplicantTablePagination(), ApplicantTablePaginationProps, ApplicantsTable(), ApplicantsTableProps (+3 more)
...
Cohesion: 0.08
Nodes (23): handlePOST(), POST, GET, handleGET(), handlePOST(), POST, GET, handleGET() (+15 more)
...
Cohesion: 0.12
Nodes (20): inviteAdmin(), inviteRecruiter(), SocialProvider, { POST, GET }, EmployersPage(), metadata, sections, auth (+12 more)
