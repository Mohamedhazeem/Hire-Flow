...
## Corpus Check
- 440 files · ~152,112 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2428 nodes · 4895 edges · 147 communities (130 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 84 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e25eb8df`
...
Cohesion: 0.16
Nodes (20): ApplicantTableFeedback(), FeedbackProps, cn(), Checkbox(), DataTableProps, DialogOverlay(), SelectGroup(), SelectLabel() (+12 more)
...
Cohesion: 0.11
Nodes (36): loginAction(), LoginActionInput, LoginActionSchema, logOutAction(), registerAction(), requestPasswordResetAction(), resetPasswordAction(), { POST, GET } (+28 more)
...
Cohesion: 0.09
Nodes (24): Props, metadata, metadata, CHART_TOOLTIP_STYLE, DistributionBarChart(), DistributionBarChartProps, FunnelChart(), FunnelChartProps (+16 more)
...
Cohesion: 0.08
Nodes (22): metadata, AdminDashboard(), CHART_TOOLTIP_STYLE, WORKMODE_COLORS, recentColumns, RecruiterDashboard(), RecruiterDashboardProps, useAdminDashboard() (+14 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (32): applyAiSuggestions(), handlePOST(), POST, ResolvedSession, DELETE, handleDELETE(), GET, handleGET() (+24 more)
...
Cohesion: 0.19
Nodes (12): metadata, AdminJobsTable(), AdminJobsTableProps, EMPLOYMENT_TYPE_LABELS, WORK_MODE_LABELS, useAdminJobs(), useDeleteJob(), useToggleJobStatus() (+4 more)

### Community 48 - "Community 48"
Cohesion: 0.12
Nodes (27): ChatHeader(), ChatHeaderProps, ChatInputArea(), ChatInputAreaProps, ChatMessageList(), ChatMessageListProps, AttachmentPreview(), AttachmentPreviewProps (+19 more)
...
Cohesion: 0.10
Nodes (19): BanDialog(), ActionButton(), ActionButtonProps, capitalizeLabel(), formatLabel(), PeopleTable(), PeopleTableProps, ROLE_OPTIONS (+11 more)
...
Cohesion: 0.15
Nodes (22): ApplicantTablePagination(), ApplicantTablePaginationProps, BanDialogProps, BulkRejectDialogProps, RevertDialogProps, ConfirmActionButtonProps, ConfirmDialog(), ConfirmDialogProps (+14 more)
...
Cohesion: 0.14
Nodes (14): NotificationDropdown(), notificationIconMap, NotificationItem, NotificationsPage(), NotificationsPageProps, recruiterLinks, RecruiterSidebar(), Channel (+6 more)

### Community 60 - "Community 60"
Cohesion: 0.09
Nodes (36): metadata, Props, BULK_ACTION_LABELS, BulkActionDef, NEXT_ACTIONS, STATUS_DOT_COLORS, STATUS_OPTIONS, ApplicantTableToolbar() (+28 more)
...
Cohesion: 0.06
Nodes (48): requireRole(), DELETE, handleDELETE(), handlePATCH(), PATCH, DELETE, handleDELETE(), GET (+40 more)
...
Cohesion: 0.11
Nodes (18): MessagesPageConfig, AdminMessagesPage(), config, AdminThreadView(), config, hooks, Props, MessageItem (+10 more)

### Community 71 - "Community 71"
Cohesion: 0.07
Nodes (32): handlePOST(), POST, GET, handleGET(), GET, handleGET(), GET, handleGET() (+24 more)
...
Cohesion: 0.13
Nodes (16): GET, handleGET(), adapter, globalForPrisma, pool, GET, handleGET(), handlePATCH() (+8 more)

### Community 74 - "Community 74"
Cohesion: 0.06
Nodes (44): saveResumeBuilder(), upsertCompany(), upsertProfile(), metadata, metadata, CompanyPage(), metadata, CompanyForm() (+36 more)

### Community 75 - "Community 75"
Cohesion: 0.09
Nodes (21): SocialProvider, socialSignInAction(), AuthLayout(), AuthLayoutProps, DustParticle(), hashToFloat(), FormButton(), FormButtonProps (+13 more)
...
Cohesion: 0.15
Nodes (8): ApiResponse, ThreadItem, ThreadLastMessage, ThreadUser, UserThreadItem, UserThreadLastMessage, UserThreadUser, useUserThreads()
...
Cohesion: 0.15
Nodes (20): ApplicantDetailDialogsProps, ApplicantsTableDialogs(), ApplicantsTableDialogsProps, ConfirmStatusDialogProps, formatDateForInput(), InterviewFormData, OfferFormData, RejectDialog() (+12 more)
...
Cohesion: 0.13
Nodes (15): geistMono, geistSans, inter, metadata, RootLayout(), AccountPopover(), MobileNavMenu(), MobileUser (+7 more)
...
Cohesion: 0.15
Nodes (13): GET, handleGET(), generateMetadata(), FeaturedJobs(), FeaturedJobsGrid(), ALLOWED_SORT_FIELDS, ALLOWED_SORT_ORDERS, getPublicJobById() (+5 more)

### Community 103 - "Community 103"
Cohesion: 0.18
Nodes (6): adapter, pool, prisma, adapter, pool, prisma
...
Cohesion: 0.12
Nodes (24): bulkInviteAdmins(), bulkInviteRecruiters(), BulkInviteResult, inviteAdmin(), inviteRecruiter(), Tab, getSession(), resend (+16 more)
...
Cohesion: 0.20
Nodes (11): metadata, AdminTeamList(), InviteAdminForm(), AdminInvite, AdminTeamMember, InviteListResponse, useAdminInvites(), useCancelInvite() (+3 more)
...
Cohesion: 0.16
Nodes (11): UnauthorizedError, ALLOWED_MIME_TYPES, saveUpload(), UPLOAD_DIR, UploadResult, GET, handleGET(), handlePOST() (+3 more)

### Community 121 - "Community 121"
Cohesion: 0.24
Nodes (7): AdminLayoutClient(), ActivityPanel(), adminLinks, AdminSidebar(), LogoutButton(), useSignOut(), metadata
...
Cohesion: 0.11
Nodes (17): metadata, AppRow, statConfig, Stats, ApplicationsPage(), AppRow, STATUSES, ApplyModal() (+9 more)
...
Cohesion: 0.24
Nodes (6): MobileMenuButton(), PersistedState, Theme, UIStore, useUIStore, themes
...
Cohesion: 0.25
Nodes (6): CareerResourcesPage(), interviewChecklist, resumeTips, salaryFAQs, sectionVariants, metadata

### Community 143 - "Community 143"
Cohesion: 0.46
Nodes (5): MessageItem, usePusherThread(), ALLOWED_FILE_TYPES, getOtherUserId(), useThreadView()
...
## Knowledge Gaps
- **1176 isolated node(s):** `$schema`, `plugin`, `snapshot`, `@kilocode/plugin`, `AcceptInviteClientProps` (+1171 more)
...
- **Why does `cn()` connect `Community 1` to `Community 130`, `Community 9`, `Community 137`, `Community 139`, `Community 12`, `Community 142`, `Community 48`, `Community 52`, `Community 55`, `Community 59`, `Community 60`, `Community 74`, `Community 89`, `Community 92`, `Community 93`, `Community 96`, `Community 97`, `Community 100`, `Community 109`, `Community 110`, `Community 115`, `Community 121`, `Community 123`, `Community 127`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 66` to `Community 65`, `Community 98`, `Community 129`, `Community 99`, `Community 71`, `Community 105`, `Community 74`, `Community 73`, `Community 108`, `Community 13`, `Community 12`, `Community 84`, `Community 54`, `Community 120`, `Community 57`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `apiClient()` connect `Community 131` to `Community 0`, `Community 130`, `Community 133`, `Community 137`, `Community 9`, `Community 138`, `Community 12`, `Community 140`, `Community 143`, `Community 47`, `Community 48`, `Community 49`, `Community 52`, `Community 59`, `Community 60`, `Community 70`, `Community 74`, `Community 83`, `Community 95`, `Community 100`, `Community 109`, `Community 110`, `Community 117`?**
