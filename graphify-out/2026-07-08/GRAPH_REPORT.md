...
## Corpus Check
- 498 files · ~172,445 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2942 nodes · 5497 edges · 166 communities (149 shown, 17 thin omitted)
...
Cohesion: 0.12
Nodes (23): DELETE, GET, handleDELETE(), handleGET(), handlePOST(), POST, ConflictError, createNotification() (+15 more)
...
Cohesion: 0.06
Nodes (44): bulkInviteAdmins(), BulkInviteResult, listJobs(), listJobs(), AdminJobsTable(), Tab, useAdminJobs(), useDeleteJob() (+36 more)

### Community 26 - "Community 26"
Cohesion: 0.09
Nodes (28): inviteAdmin(), inviteRecruiter(), ResolvedSession, { DELETE }, DELETE, { DELETE }, { DELETE }, DELETE (+20 more)
...
Cohesion: 0.07
Nodes (36): metadata, metadata, AdminDashboard(), CHART_TOOLTIP_STYLE, WORKMODE_COLORS, AdminTeamList(), InviteAdminForm(), JobDetailProps (+28 more)

### Community 30 - "Community 30"
Cohesion: 0.12
Nodes (18): BanDialog(), BanDialogProps, ActionButton(), ActionButtonProps, capitalizeLabel(), formatLabel(), PeopleTable(), PeopleTableProps (+10 more)
...
Cohesion: 0.09
Nodes (33): AdminJobsTableProps, EMPLOYMENT_TYPE_LABELS, WORK_MODE_LABELS, ApplicantTableToolbarProps, EMPLOYMENT_TYPE_OPTIONS, JobForm(), JobFormProps, WORK_MODE_OPTIONS (+25 more)
...
Cohesion: 0.16
Nodes (14): ADDITIONAL_HIDDEN_PREFIXES, AUTH_PAGES, HIDDEN_ROUTE_PREFIXES, PROTECTED_ROUTES, PUBLIC_CONTENT_PATHS, getSession(), config, proxy() (+6 more)

### Community 40 - "Community 40"
Cohesion: 0.12
Nodes (19): handlePOST(), POST, GET, handleGET(), GET, handlePOST(), POST, GET (+11 more)
...
Cohesion: 0.10
Nodes (29): BULK_ACTION_LABELS, BulkActionDef, NEXT_ACTIONS, STATUS_DOT_COLORS, STATUS_OPTIONS, addActionedIds(), getBulkActions(), useApplicantsTable() (+21 more)
...
Cohesion: 0.07
Nodes (25): DELETE, handleDELETE(), handlePATCH(), PATCH, DELETE, GET, handleDELETE(), handleGET() (+17 more)
...
Cohesion: 0.21
Nodes (12): POST(), ChatHeader(), ChatHeaderProps, MessageItem, Props, SharedThreadView(), ThreadViewConfig, ThreadViewHooks (+4 more)
...
Cohesion: 0.08
Nodes (19): metadata, metadata, metadata, metadata, emptyEducation, emptyExperience, Props, ResumeBuilderForm() (+11 more)

### Community 70 - "Community 70"
Cohesion: 0.09
Nodes (26): { DELETE }, { GET, POST, DELETE }, { GET }, { GET, POST, DELETE }, { GET }, createMessageIdDeleteHandler(), createThreadIdMessageHandlers(), createThreadListHandler() (+18 more)
...
Cohesion: 0.11
Nodes (16): Props, ThreadListItem(), ThreadListItemData, NotificationDropdown(), NotificationDropdownProps, notificationIconMap, NotificationItem, notificationIconMap (+8 more)
...
Cohesion: 0.11
Nodes (30): loginAction(), LoginActionInput, LoginActionSchema, logOutAction(), registerAction(), requestPasswordResetAction(), resetPasswordAction(), ResetPasswordForm() (+22 more)
...
Cohesion: 0.05
Nodes (58): applyAiSuggestions(), saveResumeBuilder(), upsertProfile(), requireRole(), GET, handleGET(), GET, handleGET() (+50 more)
...
Cohesion: 0.11
Nodes (14): metadata, ActivityPanel(), AppRow, statConfig, Stats, ApplicationsPage(), AppRow, STATUSES (+6 more)
...
Cohesion: 0.07
Nodes (25): SocialProvider, socialSignInAction(), { POST, GET }, auth, UserStatusResult, adapter, ADMIN, JOB_TEMPLATES (+17 more)
...
Cohesion: 0.11
Nodes (26): AdminInvite, AdminTeamMember, hooks, createInviteHooks(), InviteListItem, hooks, RecruiterInvite, RecruiterTeamMember (+18 more)

## Knowledge Gaps
- **1542 isolated node(s):** `BanDialogProps`, `ActionButtonProps`, `PeopleTableProps`, `ROLE_OPTIONS`, `UserRow` (+1537 more)
...
- **Why does `cn()` connect `Community 29` to `Community 18`, `Community 24`, `Community 30`, `Community 33`, `Community 34`, `Community 36`, `Community 38`, `Community 49`, `Community 51`, `Community 61`, `Community 65`, `Community 66`, `Community 69`, `Community 74`, `Community 93`, `Community 94`, `Community 105`, `Community 106`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 103` to `Community 21`, `Community 22`, `Community 25`, `Community 26`, `Community 27`, `Community 39`, `Community 40`, `Community 42`, `Community 172`, `Community 54`, `Community 55`, `Community 64`, `Community 69`, `Community 70`, `Community 86`, `Community 87`, `Community 89`, `Community 94`, `Community 107`, `Community 125`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `apiClient()` connect `Community 176` to `Community 34`, `Community 67`, `Community 105`, `Community 43`, `Community 109`, `Community 175`, `Community 17`, `Community 29`, `Community 18`, `Community 19`, `Community 113`, `Community 86`, `Community 23`, `Community 118`, `Community 25`, `Community 51`, `Community 28`, `Community 93`?**
...
- **What connects `BanDialogProps`, `ActionButtonProps`, `PeopleTableProps` to the rest of the system?**
