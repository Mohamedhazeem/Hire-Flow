...
## Corpus Check
- 484 files · ~173,087 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2935 nodes · 5374 edges · 165 communities (150 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 85 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f0730832`
...
Cohesion: 0.13
Nodes (13): GET, handleGET(), GET, handleGET(), GET, GET, handleGET(), withErrorHandler() (+5 more)

### Community 18 - "Community 18"
Cohesion: 0.05
Nodes (57): Props, metadata, metadata, CHART_TOOLTIP_STYLE, DistributionBarChart(), DistributionBarChartProps, FunnelChart(), FunnelChartProps (+49 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (37): metadata, metadata, AiSuggestionsPanel(), AiSuggestionsPanelProps, priorityColors, scoreColor(), typeLabels, emptyEducation (+29 more)
...
Cohesion: 0.09
Nodes (26): DELETE, GET, handleDELETE(), handleGET(), handlePOST(), POST, ConflictError, createNotification() (+18 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (56): metadata, Props, ApplicantDetailDialogs(), ApplicantDetailDialogsProps, ApplicantTableColumnsProps, createApplicantTableColumns(), BULK_ACTION_LABELS, BulkActionDef (+48 more)

### Community 24 - "Community 24"
Cohesion: 0.05
Nodes (47): AdminLayoutClient(), AdminLayout(), geistMono, geistSans, inter, metadata, RootLayout(), Providers() (+39 more)

### Community 25 - "Community 25"
Cohesion: 0.12
Nodes (19): bulkInviteAdmins(), BulkInviteResult, metadata, InviteAdminForm(), Tab, AdminAcceptInviteInput, AdminAcceptInviteSchema, AdminBanUserInput (+11 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (30): applyAiSuggestions(), handlePOST(), POST, DELETE, handleDELETE(), DELETE, handleDELETE(), DELETE (+22 more)

### Community 27 - "Community 27"
Cohesion: 0.13
Nodes (16): handlePOST(), POST, GET, handlePOST(), POST, DELETE, handleDELETE(), GET (+8 more)
...
Cohesion: 0.08
Nodes (15): InviteListResponse, RecruiterInvite, RecruiterTeamMember, apiClient(), DEFAULT_QUERY_OPTIONS, defaultQueryFn(), getQueryClient(), makeQueryClient() (+7 more)
...
Cohesion: 0.22
Nodes (8): ADDITIONAL_HIDDEN_PREFIXES, AUTH_PAGES, HIDDEN_ROUTE_PREFIXES, PROTECTED_ROUTES, PUBLIC_CONTENT_PATHS, config, RoleSchema, RoleType
...
Cohesion: 0.12
Nodes (23): config, hooks, Props, config, hooks, Props, createUseDeleteMessage(), createUseDeleteThread() (+15 more)

### Community 43 - "Community 43"
Cohesion: 0.17
Nodes (16): DELETE, GET, handleDELETE(), handleGET(), handlePOST(), POST, DELETE, GET (+8 more)
...
Cohesion: 0.09
Nodes (13): inter, metadata, newFunction(), NotFound(), JobDetailPage(), JobDetail(), EditJobPage(), AdminRecruiterDetailPage() (+5 more)
...
Cohesion: 0.21
Nodes (8): generateMetadata(), ApplyModal(), ApplyModalProps, ResumeOption, JobDetailView(), buildJobJsonLd(), hydrator, PublicJobDetail
...
Cohesion: 0.13
Nodes (21): listJobs(), listJobs(), buildOffsetMeta(), CursorPaginationMeta, CursorPaginationParams, OffsetPaginationMeta, OffsetPaginationParams, parseOffsetParams() (+13 more)
...
Cohesion: 0.27
Nodes (8): ThreadListPanel(), Channel, NotificationItem, NotificationsResponse, getPusherClient(), PresenceState, usePresenceStore, useThreadPresence()
...
Cohesion: 0.10
Nodes (18): Props, Props, ThreadListItem(), ThreadListItemData, NotificationDropdown(), NotificationDropdownProps, notificationIconMap, NotificationItem (+10 more)
...
Cohesion: 0.15
Nodes (19): AdminJobsTable(), AdminJobsTableProps, EMPLOYMENT_TYPE_LABELS, WORK_MODE_LABELS, ApplicantTableToolbarProps, useAdminJobs(), useDeleteJob(), useToggleJobStatus() (+11 more)
...
Cohesion: 0.06
Nodes (31): AcceptInviteClient(), AcceptInviteClientProps, metadata, Props, AuthCard(), Props, AuthLayout(), Props (+23 more)

### Community 93 - "Community 93"
Cohesion: 0.15
Nodes (9): Props, AdminUserProfileView(), AdminUserProfileViewProps, App, useAdminUserApplications(), AdminUserDetailPage(), ProfileHeader(), ProfileHeaderProps (+1 more)
...
Cohesion: 0.11
Nodes (19): metadata, AdminDashboard(), CHART_TOOLTIP_STYLE, WORKMODE_COLORS, AdminTeamList(), JobDetailProps, STATUS_BADGE, TABS (+11 more)
...
Cohesion: 0.05
Nodes (55): inviteAdmin(), saveResumeBuilder(), upsertProfile(), requireRole(), ResolvedSession, GET, handleGET(), DELETE (+47 more)

### Community 104 - "Community 104"
Cohesion: 0.21
Nodes (8): ThreadViewConfig, AdminMessagesPage(), config, AdminThreadView(), config, hooks, Props, useAdminThreads
...
Cohesion: 0.10
Nodes (13): metadata, metadata, metadata, InviteRecruiterForm(), RecruiterTeamList(), useCancelInvite(), useRecruiterInvites(), useRemoveMember() (+5 more)

### Community 111 - "Community 111"
Cohesion: 0.10
Nodes (17): DELETE, handleDELETE(), GET, handleGET(), DELETE, handleDELETE(), GET, handleGET() (+9 more)
...
Cohesion: 0.15
Nodes (11): MessagesPageConfig, MessagesPageLayout(), config, RecruiterMessagesPage(), RecruiterThreadView(), config, UserMessagesPage(), UserThreadView() (+3 more)
...
## Knowledge Gaps
- **1551 isolated node(s):** `$schema`, `plugin`, `snapshot`, `@kilocode/plugin`, `AcceptInviteClientProps` (+1546 more)
...
- **Why does `cn()` connect `Community 40` to `Community 18`, `Community 24`, `Community 28`, `Community 30`, `Community 34`, `Community 36`, `Community 38`, `Community 49`, `Community 51`, `Community 70`, `Community 74`, `Community 75`, `Community 79`, `Community 93`, `Community 94`, `Community 96`, `Community 107`, `Community 110`, `Community 117`, `Community 118`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `requireRole()` connect `Community 103` to `Community 17`, `Community 19`, `Community 21`, `Community 22`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 43`, `Community 54`, `Community 55`, `Community 86`, `Community 87`, `Community 88`, `Community 93`, `Community 94`, `Community 95`, `Community 106`, `Community 111`, `Community 112`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `Button()` connect `Community 38` to `Community 34`, `Community 37`, `Community 40`, `Community 28`, `Community 79`, `Community 50`, `Community 19`, `Community 29`, `Community 21`, `Community 86`, `Community 23`, `Community 25`, `Community 92`, `Community 93`, `Community 30`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Are the 29 inferred relationships involving `requireRole()` (e.g. with `handleDELETE()` and `handleDELETE()`) actually correct?**
  _`requireRole()` has 29 INFERRED edges - model-reasoned connections that need verification._
