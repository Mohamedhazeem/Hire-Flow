...
Cohesion: 0.16
Nodes (19): bulkInviteAdmins(), BulkInviteResult, inviteAdmin(), TABS, InviteBulkForm(), InviteSingleForm(), AdminAcceptInviteInput, AdminAcceptInviteSchema (+11 more)

### Community 22 - "Community 22"

Cohesion: 0.12
Nodes (25): ConflictError, ValidationError, DELETE, GET, handleDELETE(), handleGET(), handlePOST(), POST (+17 more)
...
Cohesion: 0.10
Nodes (19): fail(), handleError(), handlePOST(), POST, GET, handleGET(), handlePOST(), POST (+11 more)
...
Cohesion: 0.12
Nodes (23): ApplicantTableFeedback(), FeedbackProps, cn(), ActionButton(), ActionButtonProps, JobDetailTabs(), JobDetailTabsProps, Tab (+15 more)

### Community 30 - "Community 30"

Cohesion: 0.13
Nodes (15): BanDialog(), TableActionsCell(), TableActionsCellProps, UnbanButton(), UnbanButtonProps, useBanUser(), useUnbanUser(), AdminUserDetail (+7 more)
...
Cohesion: 0.09
Nodes (33): metadata, Props, ApplicantTablePagination(), ApplicantTableToolbar(), ApplicantTableToolbarProps, ApplicantsTable(), ApplicantsTableProps, BulkActionBar() (+25 more)
...
Cohesion: 0.13
Nodes (24): AdminJobsTable(), AdminJobsTableProps, createJobTableColumns(), EMPLOYMENT_TYPE_LABELS, JobTableToolbar(), JobTableToolbarProps, WORK_MODE_LABELS, useAdminJobs() (+16 more)
...
Cohesion: 0.12
Nodes (18): ApplicantTableColumnsProps, createApplicantTableColumns(), ApplicationActions(), Props, JobTableActionsCell(), JobTableActionsCellProps, JobTableActions, PeopleTableActions (+10 more)
...
Cohesion: 0.24
Nodes (11): listJobs(), listJobs(), buildOffsetMeta(), parseOffsetParams(), listApplicants(), AdminJobListResult, RecruiterJobDetail, RecruiterJobListResult (+3 more)
...
Cohesion: 0.20
Nodes (12): MessagesPageLayout(), Props, ThreadListPanel(), computeThreadId(), getPusherClient(), SearchResult, StartConversationSearch(), StartConversationSearchProps (+4 more)
...
Cohesion: 0.10
Nodes (12): metadata, metadata, metadata, metadata, metadata, AdminTeamList(), InviteAdminForm(), InviteRecruiterForm() (+4 more)
...
Cohesion: 0.14
Nodes (21): LoginActionInput, LoginActionSchema, disposableSet, emailSchema, ForgotPasswordSchema, PasswordSchema, ResetPasswordSchema, SignInSchema (+13 more)
...
Cohesion: 0.11
Nodes (16): apiClient(), ApiResponse, DEFAULT_QUERY_OPTIONS, defaultQueryFn(), getQueryClient(), makeQueryClient(), QueryKeyShape, ApplicantDetailPage() (+8 more)
