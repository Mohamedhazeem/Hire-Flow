...
export const AdminInviteEmail = ({ url, invitedByName }: AdminInviteEmailProps) => {
  return (
    <Html lang="en">
      <Head />
      <Preview>You&apos;ve been invited as an admin on HireFlow</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={buttonContainer}>
            ...
            <Link href={url} style={fallbackLink}>
              Click here to accept your admin invitation.
            </Link>
          </Section>
          <Text style={paragraph}>
