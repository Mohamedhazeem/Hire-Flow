  ...
  return (
    <section className="py-16 sm:py-20">
      <div className="max-w-5xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-text-heading">Featured Companies</h2>
          <p className="text-sm text-text-muted mt-1">Top employers hiring right now</p>
        </div>
