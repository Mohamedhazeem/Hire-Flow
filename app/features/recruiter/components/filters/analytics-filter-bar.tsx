...
export function AnalyticsFilterBar({ jobOptions, showJobFilter }: AnalyticsFilterBarProps) {
  ...
  const toggleMultiValue = useCallback((key: string, value: string) => {
  ...
  return (
    <div className="rounded-2xl border border-border-subtle bg-bg-surface p-4 sm:p-5 shadow-xs">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-xs font-semibold text-text-heading uppercase tracking-wider">Filters</span>
        {hasFilters && (
          <button
