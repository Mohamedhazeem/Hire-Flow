...
export function DistributionBarChart({ data, colorMap, title, subtitle, emptyMessage, className }: DistributionBarChartProps) {
  return (
    <div className={cn("rounded-2xl border border-border-subtle bg-bg-surface p-5 sm:p-6 shadow-xs transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-brand/30", className)}>
