...
export function EmployerCTA() {
  return (
    <section
      id="for-employers"
      className="bg-neutral-900 dark:bg-neutral-950 py-16 sm:py-20"
    >
      <div className="max-w-3xl mx-auto px-4 md:px-6 lg:px-8 text-center">
        ...
        <p className="text-sm sm:text-base text-neutral-400 mt-4 max-w-xl mx-auto leading-relaxed">
          HireFlow gives you access to a curated pool of top talent.
          Recruiter access is currently by invitation only &mdash; reach out
          and we&rsquo;ll get you set up.
        </p>
        <a
          href="mailto:hello@hireflow.example?subject=Recruiter%20Access%20Request"
