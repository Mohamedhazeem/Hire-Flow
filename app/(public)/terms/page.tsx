...
const sections = [
  ...
  },
  {
    title: "Contact",
    content:
      "For questions about these terms, please contact us at legal@hireflow.example.",
  },
];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-6 lg:px-8 py-16 sm:py-20">
      ...
      <p className="text-xs text-text-muted mt-12 border-t border-border-subtle pt-4">
        These are placeholder terms of service. They must be reviewed and
        replaced with legally-reviewed copy before any real launch.
      </p>
    </div>
  );
}
