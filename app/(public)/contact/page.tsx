  ...
  return (
    <div className="max-w-3xl mx-auto px-4 md:px-6 lg:px-8 py-16 sm:py-20">
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-sm text-text-body leading-relaxed">
            ...
            at{" "}
            <a
              href="mailto:hello@hireflow.example"
        ...
        <div>
          ...
          <p className="text-sm text-text-body leading-relaxed">
            ...
            <a
              href="mailto:support@hireflow.example"
              className="text-brand hover:underline"
            >
      ...
      <p className="text-xs text-text-muted mt-12 border-t border-border-subtle pt-4">
        This is a placeholder contact page. It must be reviewed and replaced
        with real contact details before any launch.
      </p>
    </div>
  );
}
