...
export const rateLimitConfig = {
  ...
  endpoints: {
    ...
    "admin:dashboard": { max: 30, windowMs: 60_000 },
    "admin:users:list": { max: 30, windowMs: 60_000 },
    "admin:users:detail": { max: 60, windowMs: 60_000 },
    "admin:users:manage": { max: 20, windowMs: 60_000 },
    "admin:jobs:list": { max: 30, windowMs: 60_000 },
    "admin:jobs:manage": { max: 20, windowMs: 60_000 },
    "admin:applications:detail": { max: 60, windowMs: 60_000 },
    "admin:invite:list": { max: 30, windowMs: 60_000 },
    "admin:invite:manage": { max: 10, windowMs: 60_000 },
    "admin:invite:accept": { max: 5, windowMs: 60_000 },
    "admin:team:manage": { max: 10, windowMs: 60_000 },
    "admin:messages:search": { max: 30, windowMs: 60_000 },

    "recruiter:jobs:list": { max: 30, windowMs: 60_000 },
    "recruiter:jobs:manage": { max: 20, windowMs: 60_000 },
    "recruiter:jobs:analytics": { max: 20, windowMs: 60_000 },
    "recruiter:applicants:list": { max: 30, windowMs: 60_000 },
    "recruiter:applicants:export": { max: 5, windowMs: 60_000 },
    "recruiter:applications:manage": { max: 20, windowMs: 60_000 },
    "recruiter:applications:detail": { max: 60, windowMs: 60_000 },
    "recruiter:analytics": { max: 20, windowMs: 60_000 },
    "recruiter:invite:list": { max: 30, windowMs: 60_000 },
    "recruiter:invite:manage": { max: 10, windowMs: 60_000 },
    "recruiter:invite:accept": { max: 5, windowMs: 60_000 },
    "recruiter:team:manage": { max: 10, windowMs: 60_000 },
    "recruiter:messages:search": { max: 30, windowMs: 60_000 },
    "recruiter:company:manage": { max: 10, windowMs: 60_000 },
