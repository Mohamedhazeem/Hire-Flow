...
export function DataTable<TData>({
  ...
  return (
    ...
    >
      <Table>
        <TableHeader>
          <TableRow className="bg-gradient-to-r from-bg-elevated via-bg-elevated to-bg-elevated/50 hover:bg-gradient-to-r hover:from-bg-elevated hover:via-bg-elevated hover:to-bg-elevated/50 border-b-2 border-border-subtle">
            {columns.map((col) => (
              <TableHead
                key={col.key}
                className={cn(
            ...
            <TableRow>
              ...
              >
                <div className="flex flex-col items-center gap-2">
                  <svg className="size-8 text-text-muted/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
