...
export function ChartCard({ icon, iconBg, iconColor, title, subtitle, children, className }: ChartCardProps) {
  return (
    <div
    ...
    >
      <div className="flex items-center gap-2.5 mb-5">
        <div className={`size-9 rounded-xl ${iconBg} flex items-center justify-center ${iconColor}`}>{icon}</div>
        <div>
